...
- **Shelly Pro 3EM** — uses port 1010 (B2500 firmware up to v224) and port 2220
  ...
  `shellypro3em_new` (2220). It also announces itself on your network and serves
  a Shelly HTTP surface, so batteries that discover meters by themselves find it
  with no setup — see
