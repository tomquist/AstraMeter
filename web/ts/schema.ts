...
export const CT_BALANCER: Field[] = [
  ...
  { key: "HUNT_DEADBAND_EXTRA", ey: "hunt_deadband_extra", label: "Hunting deadband (W)", help: "While a battery is hunting (chasing meter noise it can't cancel), drop tiny corrections to zero instead of issuing them — cutting wasted battery wear and grid swings without losing self-consumption (genuine load/solar steps still react immediately). Default 35; 0 = off.", type: "number", placeholder: "35" },
