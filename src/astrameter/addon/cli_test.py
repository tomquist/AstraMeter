...
def run_main(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(main_module, "_build_managed_marstek", lambda cfg, types: {})
    ...
    def _async_main(cfg, args, device_types, device_ids, skip_test, managed):
        captured["cfg"] = cfg
        captured["args"] = args
        captured["device_types"] = device_types
    ...
    monkeypatch.setattr(main_module, "async_main", _async_main)
