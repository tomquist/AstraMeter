...
- **Changed** the AstraMeter website (landing page and config generator) to its own domain, [astrameter.com](https://astrameter.com); the config generator is now at [astrameter.com/generator.html](https://astrameter.com/generator.html).
