...
- **Added** documentation for running a P1 smart meter and the emulator on one ESP32, reading the meter directly over DSMR instead of through a separate bridge ([#664](https://github.com/tomquist/astrameter/issues/664), [#665](https://github.com/tomquist/astrameter/pull/665)).
