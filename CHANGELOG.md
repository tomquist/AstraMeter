...
- **Added** Refoss / Meross energy monitors (EM01P, EM06P, EM16P) as a power source (`[REFOSS]` or `[MEROSS]`): AstraMeter reads signed channel power over the local Open API — set `IP` and `CHANNELS` (one id for single-phase, or three for L1/L2/L3). See [docs/powermeters.md](docs/powermeters.md#refoss--meross-energy-monitor) ([#593](https://github.com/tomquist/astrameter/pull/593)).
