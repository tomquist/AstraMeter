...
## Next
- Exposed `MIN_EFFICIENT_POWER` and `EFFICIENCY_ROTATION_INTERVAL` settings in the Home Assistant add-on configuration UI so users can tune efficiency optimization without a custom config file
