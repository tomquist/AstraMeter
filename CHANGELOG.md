...
## Next
- Fixed false saturation detection during load sign reversal (discharge-to-charge or vice versa) that caused ping-pong rotation between batteries when solar conditions changed
