...
- **Added** the **Fronius Smart Meter** as a power source (`[FRONIUS]`): AstraMeter reads grid power through a Fronius inverter's local Solar API — positive = import, negative = feed-in. See [docs/powermeters.md](docs/powermeters.md#fronius-smart-meter).
