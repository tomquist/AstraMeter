...
- **Added** a **control quality** reading that says whether AstraMeter is actually holding your grid at zero, and how it misses when it isn't — stable, oscillating, sluggish or limited by full/empty batteries — as two Home Assistant diagnostic sensors and on the dashboard's Diagnostics tab. See [docs/ct002.md](docs/ct002.md#control-quality).
