...
- **Added** opt-in **HTTP cloud reporting** for the CT002/CT003 emulator (Python and ESPHome): when enabled, AstraMeter reports to Marstek's cloud (`hamedata.com`) like a real CT, so the Marstek app shows live grid power for your emulated meter. Off by default. See [docs/marstek-mqtt-http.md](docs/marstek-mqtt-http.md#6-http-cloud-reporting-both-models) ([#500](https://github.com/tomquist/astrameter/pull/500), [#506](https://github.com/tomquist/astrameter/pull/506)).
