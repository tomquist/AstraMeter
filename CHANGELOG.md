...
## Next
- EMA smoothing and deadband gating are now composable per-powermeter wrappers (`SMOOTH_TARGET_ALPHA`, `DEADBAND`, `MAX_SMOOTH_STEP` configurable per powermeter section with `[GENERAL]` fallback) instead of being embedded in the CT002 emulator
