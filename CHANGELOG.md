...
- **Changed** the **Force Rotation** button on the CT002/CT003 device in Home Assistant to appear only when efficiency rotation is enabled, so it's no longer shown when it would have nothing to do.
