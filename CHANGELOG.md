...
- When an efficiency probe is rejected, immediately chain into probing the next healthy standby consumer instead of waiting for the restored active to re-saturate, reducing recovery time after a failed hand-off
