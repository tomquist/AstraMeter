...
- **Added** a **control quality** reading that says whether AstraMeter is actually holding your grid at zero — stable, off target, or limited by full/empty batteries — as Home Assistant diagnostic sensors and on the dashboard's Diagnostics tab, with the mean grid error, time spent on target and zero-crossing rate behind the verdict. See [docs/ct002.md](docs/ct002.md#control-quality) ([#599](https://github.com/tomquist/astrameter/pull/599)).
